import { _decorator, Button, Component, director, game, Node, ScrollViewComponent, Layout, Vec2 } from 'cc';
...
export class BackButton extends Component {
    ...
    public static saveOffset () {
        if ( BackButton._scrollNode ) {
            BackButton._offset = new Vec2(0, BackButton._scrollCom!.getScrollOffset().y);
        }
    }
    ...
    private static _offset = new Vec2();
